...
CREATE TABLE `categorys` (
    ...
    UNIQUE INDEX `categorys_name_key`(`name`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `products` (
    ...
    `name` VARCHAR(191) NOT NULL,
    `desc` VARCHAR(191) NULL,
    `regularPrice` DECIMAL(65, 30) NULL,
...
CREATE TABLE `product_images` (
    ...
    UNIQUE INDEX `product_images_productId_imageUrl_key`(`productId`, `imageUrl`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `categorys` ADD CONSTRAINT `categorys_parentId_fkey` FOREIGN KEY (`parentId`) REFERENCES `categorys`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
